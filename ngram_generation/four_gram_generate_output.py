...
model = kenlm.LanguageModel('four_gram_model.binary')
...
# Load vocabulary
vocabulary = get_vocabulary_from_arpa('four_gram_model.arpa')
...
df.to_csv("four_gram_generation_results_30tokens.csv", index=False)  # Save results to a CSV file
