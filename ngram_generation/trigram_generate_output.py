...
model = kenlm.LanguageModel('trigram_model.binary')
...
# Load vocabulary
vocabulary = get_vocabulary_from_arpa('trigram_model.arpa')
...
df.to_csv("trigram_generation_results_30tokens.csv", index=False)  # Save results to a CSV file
